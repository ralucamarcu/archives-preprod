...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[saisie_donnees_pages_preprod] (
		...
		[image_origine]           [varchar](255) COLLATE French_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[saisie_donnees_pages_preprod] SET (LOCK_ESCALATION = TABLE)
GO
