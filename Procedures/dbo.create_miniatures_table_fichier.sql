...
-- =============================================
create PROCEDURE [dbo].[create_miniatures_table_fichier] 
	-- Add the parameters for the stored procedure here
	-- Test Run : [create_miniatures_table_fichier] 'F0300298-AE1F-4586-91F8-AC77E85ADC4B'
...
BEGIN
	...
	set @id_projet = (select id_projet from Ithaque.dbo.AEL_Parametres_nouveau with (nolock)
	...
	select id_page, image_viewer from archives.dbo.saisie_donnees_pages with (nolock) 
		where id_document = @id_document
	 open cursor_1
...
PRINT 1
		set @command = '"C:\Program Files\Microsoft SQL Server\100\Tools\Binn\bcp.exe" [archives].[dbo].[tmp_miniatures] out \\10.1.0.196\bigvol\Jobs\miniatures_fichiers_recensement\' 
			+ @nom_fichier + '.csv -T -E -SSQLSEARCH1 -t -c'	
	END
	ELSE
	BEGIN
PRINT 2
