...
-- =============================================
CREATE PROCEDURE  [dbo].[saisie_donnees_maj_images_actes_geonames_nouveau]
	-- Add the parameters for the stored procedure here
	-- Test Run : [saisie_donnees_maj_images_actes_geonames_nouveau]  'BC9B3EA8-4245-4847-86EB-7F7A91F5DDB4'
...
BEGIN
	...
	SET @id_projet = (SELECT id_projet FROM Ithaque.dbo.AEL_Parametres_nouveau WHERE id_document = @id_document AND principal = 1 )
